        ...
        <section style={{ padding: '3rem 1rem' }}>
          <div style={{ maxWidth: '80rem', margin: '0 auto' }}>
            <div style={{ 
              ...
              {/* RIGHT: Video Card */}
{/* RIGHT: Video Card Section */}
<div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
  
  {/* Clickable Text Above Video Card */}
  <a
    href="/dashboard" // <-- replace with your actual dashboard route
    style={{
      marginBottom: '1rem',
      color: 'rgb(30, 64, 175)', // nice blue
      fontWeight: 600,
      fontSize: '1rem',
      textDecoration: 'none',
      cursor: 'pointer',
    ...
    onMouseEnter={(e) => (e.currentTarget.style.color = 'rgb(21, 94, 239)')}
    onMouseLeave={(e) => (e.currentTarget.style.color = 'rgb(30, 64, 175)')}
  >
    Go to Dashboard
  </a>
...
></div>
        ...
        >
          <motion.img
  src={step.image}
  alt="Meeting Recording Screen"
  initial={{ opacity: 0, y: 24 }}
  animate={{ opacity: 1, y: 0 }}
  transition={{ duration: 0.45, ease: 'easeOut' }}
  style={{
    width: '100%',
    maxWidth: '1100px',   // 👈 desktop perfect
